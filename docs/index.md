...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
    <a href="/docs/onboarding" class="docs-card-2 rounded-lg">
    ...
    <a href="/docs/features" class="docs-card-2 rounded-lg">
    ...
    <a href="/docs/sdks" class="docs-card-2 rounded-lg">
    ...
    <a href="/docs/dashboard" class="docs-card-2 rounded-lg">
